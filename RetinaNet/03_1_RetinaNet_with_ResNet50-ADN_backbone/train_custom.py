...
'''
    ...
    --test-only --weights-path /home/hslee/INU_RISE/03_2_Loss_Develop/pretrained/exp1_goodF_alpha05_noBeta_pyTorchSchedule_model_23.pth \
    2>&1 | tee ./logs/exp6_goodF_alpha05_noBeta_model_23_test.txt
