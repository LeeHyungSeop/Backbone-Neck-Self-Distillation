...
python train.py --data coco.yaml --epochs 300 --weights '' --cfg yolov5l.yaml  --batch-size 16 2>&1 | tee logs/test.txt


python -m torch.distributed.run --nproc_per_node 1 train.py \
    --data coco.yaml --weights yolov5s.pt --img 640 --device 0 \
